  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-medium text-neutral-900 dark:text-neutral-200">模型</h3>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="搜索模型..."
          className="w-full bg-white/5 border border-glass-border rounded-xl pl-10 pr-4 py-2.5 text-sm text-neutral-900 dark:text-neutral-200 outline-none focus:border-accent-500/40 transition-colors placeholder-neutral-500"
        />
      </div>
              ...
              {models.map((model) => (
                <div key={`${model.providerId}-${model.id}`}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm text-neutral-900 dark:text-neutral-200">{model.name}</div>
