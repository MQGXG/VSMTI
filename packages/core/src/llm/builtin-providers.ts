...
export const BUILTIN_PROVIDERS: ProviderDef[] = [
  {
    ...
    models: [
      { id: "gpt-4o", label: "GPT-4o", context: 128000, capabilities: ["chat", "vision", "tool_use"], cost: { inputPer1K: 0.0025, outputPer1K: 0.01 } },
      { id: "gpt-4o-mini", label: "GPT-4o Mini", context: 128000, capabilities: ["chat", "tool_use"], cost: { inputPer1K: 0.00015, outputPer1K: 0.0006 } },
      { id: "gpt-4-turbo", label: "GPT-4 Turbo", context: 128000, capabilities: ["chat", "vision", "tool_use"], cost: { inputPer1K: 0.01, outputPer1K: 0.03 } },
      { id: "gpt-4", label: "GPT-4", context: 8192, capabilities: ["chat", "tool_use"], cost: { inputPer1K: 0.03, outputPer1K: 0.06 } },
      { id: "gpt-3.5-turbo", label: "GPT-3.5 Turbo", context: 16385, capabilities: ["chat", "tool_use"], cost: { inputPer1K: 0.0005, outputPer1K: 0.0015 } },
      { id: "o1", label: "o1", context: 200000, capabilities: ["chat", "tool_use", "thinking"], cost: { inputPer1K: 0.015, outputPer1K: 0.06 } },
      { id: "o3-mini", label: "o3-mini", context: 200000, capabilities: ["chat", "tool_use", "thinking"], cost: { inputPer1K: 0.0011, outputPer1K: 0.0044 } },
    ],
  },
  {
    ...
    models: [
      { id: "claude-sonnet-4-20250514", label: "Claude Sonnet 4", context: 200000, capabilities: ["chat", "tool_use", "vision", "thinking"], cost: { inputPer1K: 0.003, outputPer1K: 0.015 } },
      { id: "claude-4-20250514", label: "Claude 4", context: 200000, capabilities: ["chat", "tool_use", "vision", "thinking"], cost: { inputPer1K: 0.005, outputPer1K: 0.025 } },
      { id: "claude-opus-4-20250514", label: "Claude Opus 4", context: 200000, capabilities: ["chat", "tool_use", "vision", "thinking"], cost: { inputPer1K: 0.015, outputPer1K: 0.075 } },
      { id: "claude-haiku-4-20250514", label: "Claude Haiku 4", context: 200000, capabilities: ["chat", "tool_use", "vision", "thinking"], cost: { inputPer1K: 0.001, outputPer1K: 0.005 } },
      { id: "claude-3-5-sonnet-20241022", label: "Claude 3.5 Sonnet", context: 200000, capabilities: ["chat", "tool_use", "vision"], cost: { inputPer1K: 0.003, outputPer1K: 0.015 } },
      { id: "claude-3-5-haiku-20241022", label: "Claude 3.5 Haiku", context: 200000, capabilities: ["chat", "tool_use", "vision"], cost: { inputPer1K: 0.0008, outputPer1K: 0.004 } },
    ],
  },
  {
    ...
    models: [
      { id: "deepseek-chat", label: "DeepSeek V3", context: 64000, capabilities: ["chat", "tool_use"], cost: { inputPer1K: 0.00027, outputPer1K: 0.0011 } },
      { id: "deepseek-reasoner", label: "DeepSeek R1", context: 64000, capabilities: ["chat", "tool_use", "thinking"], cost: { inputPer1K: 0.00055, outputPer1K: 0.00219 } },
    ],
  },
  {
