...
export const readFileTool = make({
  name: "read_file",
  description: "Read file content or list directory contents. Use this BEFORE modifying any file to understand its current state. Supports text files, images, and directory listing. Use when: reading file content, checking code before editing, examining config files, listing directory contents, viewing images.",
