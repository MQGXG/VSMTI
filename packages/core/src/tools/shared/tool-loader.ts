...
const TOOL_KEYWORDS: Record<string, string[]> = {
  ...
  lsp_symbols: ["symbols", "符号", "符号大纲", "文件符号", "outline"],
  lsp_implementations: ["implementations", "实现", "查找实现", "implementations of"],
  lsp_rename: ["rename", "重命名", "改名", "renaming", "跨文件重命名"],
